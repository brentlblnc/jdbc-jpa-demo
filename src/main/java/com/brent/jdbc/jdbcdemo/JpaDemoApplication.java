...
public class JpaDemoApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		logger.info("Inserting user 10004 -> {}", repo.insert(new Person("Brent", "Truro", new Date())));
		logger.info("Updating user with ID 10002 -> {}", repo.update(new Person(10002, "Dan", "Toronto", new Date())));
